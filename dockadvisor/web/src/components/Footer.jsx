...
export function Footer() {
    return (
        <footer className="bg-slate-50">
            <Container>
                <div className="py-16">
                    <a href="https://deckrun.com" target="_blank" aria-label="Deckrun">
                ...
                <div
                    ...
                    <div className="flex gap-x-6">
                        <a
                            href="https://x.com/deckruncom"
                            className="group"
                            aria-label="Deckrun on X"
                        >
                            <svg
                        ...
                        <a
                            href="https://github.com/deckrun"
                            className="group"
                            aria-label="Deckrun on GitHub"
                        >
                            <svg
                                aria-hidden="true"
                                className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700"
                    ...
                    <p className="mt-6 text-sm text-slate-500 sm:mt-0">
                        Copyright &copy; {new Date().getFullYear()} Deckrun. All rights reserved
                    </p>
                </div>
            </Container>
        </footer>
